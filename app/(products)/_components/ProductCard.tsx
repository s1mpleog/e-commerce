...
export default async function ProductCard({}: ProductCardProps) {
  ...
  return (
    <div className="grid lg:grid-cols-4 lg:mx-0 mx-5 grid-cols-2 lg:gap-20 gap-5 md:px-10 px-5 my-10 items-start">
      {products?.map((product) => (
        <Link href={`product/${product.id}`} key={product.id}>
          <div className="flex flex-col lg:max-w-[300px] max-w-[250px] space-y-6 items-center justify-between">
